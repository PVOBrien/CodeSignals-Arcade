...
public class DivingDeeperTest {
    ...
    @Nested
    @DisplayName("Array Max Consecutive Sum")
    public class ArrayMaxConsecutiveSumTest {

        ArrayMaxConsecutiveSum aMCS = new ArrayMaxConsecutiveSum();

        @Test
        public void aMSCTest1() {
            int[] inputArr = new int[]{2, 3, 5, 1, 6};
            assertEquals(8, aMCS.solution(inputArr, 2));
        }

        @Test
        public void aMSCTest2() {
            int[] inputArr = new int[]{2, 4, 10, 1};
            assertEquals(14, aMCS.solution(inputArr, 2));
        }

        @Test
        public void aMSCTest3() {
            int[] inputArr = new int[]{1, 3, 2, 4};
            assertEquals(9, aMCS.solution(inputArr, 3));
        }

        @Test
        public void aMSCTest4() {
            int[] inputArr = new int[]{3, 2, 1, 1};
            assertEquals(3, aMCS.solution(inputArr, 1));
        }

        @Test
        public void aMSCTest5() {
            int[] inputArr = new int[]{1, 3, 4, 2, 4, 2, 4};
            assertEquals(13, aMCS.solution(inputArr, 4));
        }

        @Test
        public void aMSCTest6() {
            int[] inputArr = new int[]{ 768,
                    77,
                    755,
                    960,
                    747,
                    ...
                    32,
                    219};
            assertEquals(135845, aMCS.solution(inputArr, 250));
        }

        @Test
        public void aMSCTest7() {
            int[] inputArr = new int[]{963, 741, 22, 851, 399, 382, 190, 247, 494, 452, 891, 532, 795, 920, 465, 831, 344, 391, 582, 897, 763, 951, 735, 806, 320, 702, 200, 59, 870, 345, 695, 321, 817, 83, 416, 36, 914, 335, 117, 985, 690, 303, 875, 556, 292, 309, 496, 791, 509, 360, 235, 784, 607, 341};
            assertEquals(14232, aMCS.solution(inputArr, 23));
        }

        @Test
        public void aMSCTest8() {
            int[] inputArr = new int[]{186,
                    923,
                    553,
                    569,
                    686,
                    ...
                    452,
                    237};
            assertEquals(400098, aMCS.solution(inputArr, 785));
        }

        @Test
        public void aMSCTest9() {
            int[] inputArr = new int[]{  152,
                    503,
                    151,
                    221,
                    768,
                    ...
                    936,
                    10};
            assertEquals(377666, aMCS.solution(inputArr, 776));
        }

        @Test
        public void aMSCTest10() {
            int[] inputArr = new int[]{18,
                    872,
                    747,
                    579,
                    38,
                    ...
                    905,
                    131};
            assertEquals(345095, aMCS.solution(inputArr, 671));
        }
    }
